...
# generate the user-tag, item-tag matrix
...
def gen_context(df, data_count, ratio, n_components):
    ...
    sub_df = df[:int(ratio * df.shape[0])]
...
def main():
    ...
    print("generate the sub_df and context")
    ...
    print("generate user_selected = {user : set(selected item)}")
